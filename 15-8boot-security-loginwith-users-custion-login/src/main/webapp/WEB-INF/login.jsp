	...
	<div class="container">
		<form method="POST" action="/login" class="formsignin">
			...
			<div class="form-group ">
				<span></span> <input name="username" type="text" class="form-control" placeholder="Username" /> 
				<input name="password" type="password" class="form-control" placeholder="Password" /> <span></span>
